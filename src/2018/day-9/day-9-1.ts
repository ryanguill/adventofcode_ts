...
/*
  ...
  execute solution:
    clear && npm run compile && time node --trace-warnings --async-stack-traces dist/2018/day-9/day-9-1.js

  unit test
    clear && npm run compile && ./node_modules/.bin/mocha --ui tdd dist/2018/day-9/day-9-1.js
...
if (!isRunningUnitTests()) {
  (async function main() {
    ...
    const input = '431 players; last marble is worth 70950 points';
    console.log({ answer: playGame(431, 70950) });
