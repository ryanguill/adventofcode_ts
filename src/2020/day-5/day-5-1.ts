...
/*
  ...
  execute solution:
    clear && npm run compile && time node --trace-warnings --async-stack-traces dist/2020/day-5/day-5-1.js

  unit test
    clear && npm run compile && ./node_modules/.bin/mocha --ui tdd dist/2020/day-5/day-5-1.js
...
if (!isRunningUnitTests()) {
  (async function main() {
    ...
    const answer = rawInput.reduce((a,b) => Math.max(a,b));
