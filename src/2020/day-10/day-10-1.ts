...
/*
  ...
  execute solution:
    clear && npm run compile && time node --trace-warnings --async-stack-traces dist/2020/day-10/day-10-1.js

  unit test
    clear && npm run compile && ./node_modules/.bin/mocha --ui tdd dist/2020/day-10/day-10-1.js
...
if (!isRunningUnitTests()) {
  (async function main() {
    ...
    //console.log(get_joltage_differences(small_input));
    //console.log(get_joltage_differences(medium_input));
    const differences = get_joltage_differences(large_input);
    console.log({differences});
    console.log({answer: (differences.get(1) || 0) * (differences.get(3) || 0)});
