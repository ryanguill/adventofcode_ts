...
/*
  ...
  execute solution:
    clear && npm run compile && time node --trace-warnings --async-stack-traces dist/2019/day-1/day-1-2.js

  unit test
    clear && npm run compile && ./node_modules/.bin/mocha --ui tdd dist/2019/day-1/day-1-2.js
